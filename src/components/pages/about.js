...
export default function AboutMe() {
  return (
      <div className=''>
          <h1>About Me</h1>
          <div className = 'photo d-flex col-6'>
          <img src = {Me} width={175} height={375} alt ="Myphoto" className='mePhoto'></img>
          
          <p className='text-center col-6 align-text-bottom'> Hello my name is Vanessa Mendez and I'm an aspiring Full Stack Developer.
